...
/** Experiments definitions for the 'lr' bundle. */
@Configuration
@ComponentScan( // Scan for annotated Peel components in the 'eu.e2data.benchmarks.lr' package
  value = Array("eu.e2data.benchmarks.lr"),
