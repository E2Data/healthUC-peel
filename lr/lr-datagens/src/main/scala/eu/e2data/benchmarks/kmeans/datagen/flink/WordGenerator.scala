package eu.e2data.benchmarks.kmeans.datagen.flink

import org.apache.flink.api.scala._
import org.apache.flink.core.fs.FileSystem
import org.apache.flink.util.NumberSequenceIterator
import eu.e2data.benchmarks.kmeans.datagen.flink.Distributions.{Zipf, Binomial, DiscreteUniform, DiscreteDistribution}
import eu.e2data.benchmarks.kmeans.datagen.util.RanHash
